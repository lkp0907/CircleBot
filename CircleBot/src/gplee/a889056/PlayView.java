...
public class PlayView {
	...
	private class DrawCircle extends JPanel {
		...
		public void paint(Graphics g) {
			...
			Font font = new Font("Arial", Font.PLAIN, circleRadius/10);


			g2d.setFont(font);
			g2d.rotate(Math.toRadians(count),width/2,height/2);

			drawCirclePiece(0,"1",0,45);
			drawCirclePiece(1,"2",45,45);
			drawCirclePiece(2,"3",90,45);
			drawCirclePiece(3,"4",135,45);
			drawCirclePiece(4,"5",180,45);
			drawCirclePiece(5,"6",225,45);
			drawCirclePiece(6,"7",270,45);
			drawCirclePiece(7,"8",315,45);
